...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('classes', '0005_auto_20161008_1608'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.IntegerField(default=0, verbose_name=b'Estado', choices=[(0, b'Privada'), (1, b'P\xc3\xbablica')])),
                ('session_type', models.IntegerField(default=0, verbose_name=b'Tipo', choices=[(0, b'Regular'), (1, b'Prueba'), (2, b'Recuperativa')])),
