...
# Version Views
# =============
class VersionDetail(TestsUserPassesTestMixin, TestMixin, generic.DetailView):
    model = Version
...
# Question Views
# ==============
class ChoiceQuestionCreate(TestsUserPassesTestMixin, VersionMixin, generic.CreateView):
